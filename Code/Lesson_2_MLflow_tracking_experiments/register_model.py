...
HPO_EXPERIMENT_NAME = "Lesson2_Experiment_tracking_Homework_Q5"
EXPERIMENT_NAME = "random-forest-best-modelsQ6"
...
def run(data_path, log_top):
    ...
    result = mlflow.register_model( f"runs:/{best_run.info.run_id}/model" , "Lesson2_Experiment_tracking_Homework_Q6")
